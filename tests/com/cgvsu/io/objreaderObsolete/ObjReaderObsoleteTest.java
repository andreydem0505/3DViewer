package com.cgvsu.io.objreaderObsolete;

import com.cgvsu.io.objreaderObsolete.ObjReaderObsolete;
import com.cgvsu.io.objreaderObsolete.ObjReaderException;
...
class ObjReaderObsoleteTest {

    @Test
    public void testParseVertex01() {
        ArrayList<String> wordsInLineWithoutToken = new ArrayList<>(Arrays.asList("1.01", "1.02", "1.03"));
        Vector3f result = ObjReaderObsolete.parseVertex(wordsInLineWithoutToken, 5);
    ...
    public void testParseVertex03() {
        ...
        try {
            ObjReaderObsolete.parseVertex(wordsInLineWithoutToken, 10);
